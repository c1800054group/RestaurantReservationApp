...
public class ReservationInsertTask extends AsyncTask<String, Integer, String> {
    private final static String TAG = "ReservationInsertTask ";
    private String url, outStr;

    public ReservationInsertTask(String url, String outStr) {
        this.url = url;
        this.outStr = outStr;
    }
