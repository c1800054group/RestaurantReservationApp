...
public class MenuModifyFragmentSub extends Fragment {
    ...
    private final static String TAG = "Subfragment"; //log用
...
//                    getParentFragment().getFragmentManager().beginTransaction().replace(R.id.main_activty, update).addToBackStack("").commit();
                }
            });
