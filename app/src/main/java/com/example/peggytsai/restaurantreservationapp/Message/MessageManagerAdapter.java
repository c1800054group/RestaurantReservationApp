...
public class MessageManagerAdapter extends RecyclerView.Adapter<MessageManagerAdapter.MyViewHolder>{
    ...
    public MessageManagerAdapter(List<Message> messages, Context context, FragmentManager fragmentManager) {
    ...
    @Override
    public MessageManagerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MessageManagerAdapter.MyViewHolder myViewHolder, int position) {
